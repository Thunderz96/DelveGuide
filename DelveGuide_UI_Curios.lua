...
DelveGuide.RenderCurios = function()
    ...
    if rec then
        ...
        y=y+6
        y=y+UI.CreateRow(cf,y,"|cFFFF8844[Nemesis Warning]|r Mandate of Sacred Death procs require profession nodes. TBD: verify Venomfall Deeps arena nodes on PTR (Nullaeus's arena had none - swap to Overflowing Voidspire or Ebon Crown).")
        y=y+8
    else
